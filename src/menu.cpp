...
namespace raymino {
	...
	void Menu::UpdateDraw(App &app) {
		...
		if (::GuiButton(ButtonHighscoresRect,
		                state == State::HighScores ? GroupBoxSettingsText : ButtonHighscoresText)) {
	...
	void Menu::UpdateDrawSettings([[maybe_unused]] App &app) {
		...
		GuiDropdownBox(
			SettingsRects[1][5][1], DropdownBoxGhostPieceText, DropdownBoxGhostPieceActive,
			DropdownBoxGhostPieceEditMode);
		GuiDropdownBox(
			SettingsRects[1][4][1], DropdownBoxLevelGoalTextList, DropdownBoxLevelGoalActive,
		...
		GuiDropdownBox(SettingsRects[1][0][1], DropdownBoxTSpinTextList, DropdownBoxTSpinActive,
		               DropdownBoxTSpinEditMode);
		...
		GuiDropdownBox(
			SettingsRects[0][3][1], DropdownBoxSoftDropTextList, DropdownBoxSoftDropActive,
			DropdownBoxSoftDropEditMode);
		GuiDropdownBox(
			SettingsRects[0][2][1], DropdownBoxLockDownTextList, DropdownBoxLockDownActive,
			DropdownBoxLockDownEditMode);
		GuiDropdownBox(
			SettingsRects[0][1][1], DropdownBoxWallKicksTextList, DropdownBoxWallKicksActive,
	...
	void drawClose(const Rectangle &bounds, const char *text, App &app, [[maybe_unused]] const char *namePtr,
	               [[maybe_unused]] const App::Settings *setPtr,
	...
	void Menu::UpdateDrawKeyBinds([[maybe_unused]] App &app) {
		...
		guiKeyBind(SettingsRects[0][3][0], LabelHoldText, SettingsRects[0][3][1], TextBoxHoldBuffer,
		           TextBoxHoldEditMode,
		           keyBindsPresets.getValue().hold);
		guiKeyBind(SettingsRects[0][4][0], LabelPauseText, SettingsRects[0][4][1], TextBoxPauseBuffer,
		           TextBoxPauseEditMode,
		...
		guiKeyBind(SettingsRects[1][3][0], LabelMenuText, SettingsRects[1][3][1], TextBoxMenuBuffer,
		           TextBoxMenuEditMode,
