...
{
	/**
	 * @brief called every frame before draw to run update logic
	 */
	virtual void Update(class App& app) = 0;
	/**
	 * @brief called every frame after update to draw everything
	 */
	virtual void Draw(class App& app) = 0;
	/**
